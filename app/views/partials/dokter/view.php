                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-id_dokter">
                                        <th class="title"><i class="fa fa-database "></i> Id Dokter: </th>
                                        <td class="value"> <?php echo $data['id_dokter']; ?></td>
                                    </tr>
                                    <tr  class="td-nama">
                                        <th class="title"><i class="fa fa-user "></i> Nama: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-nomor_hp">
                                        <th class="title"><i class="fa fa-contao "></i> Nomor Hp: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-alamat">
                                        <th class="title"><i class="fa fa-map "></i> Alamat: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-photo">
                                        <th class="title"><i class="fa fa-file-photo-o "></i> Photo: </th>
