                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id_obat"><a href="<?php print_link("obat/view/$data[id_obat]") ?>"><?php echo $data['id_obat']; ?></a></td>
                                                    <td class="td-nama_obat">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['nama_obat']; ?>" 
                                                            data-pk="<?php echo $data['id_obat'] ?>" 
                                                            data-url="<?php print_link("obat/editfield/" . urlencode($data['id_obat'])); ?>" 
                                                            data-name="nama_obat" 
