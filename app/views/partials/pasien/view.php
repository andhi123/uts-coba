...
$can_add = ACL::is_allowed("pasien/add");
$can_edit = ACL::is_allowed("pasien/edit");
$can_view = ACL::is_allowed("pasien/view");
$can_delete = ACL::is_allowed("pasien/delete");
?>
<?php
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-jk">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['jk']; ?>" 
                                                data-pk="<?php echo $data['id_pasien'] ?>" 
                                                data-url="<?php print_link("pasien/editfield/" . urlencode($data['id_pasien'])); ?>" 
                                                data-name="jk" 
                                                data-title="Enter Jk" 
